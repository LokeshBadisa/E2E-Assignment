...
def get_args_parser():
    ...
    parser.add_argument('--runname', type=str,default='first')#required=True)
    parser.add_argument('--wpath', type=str,default='./maskrat15/last.pt')#required=True)
...
if __name__ == "__main__":
    ...
    model = FineTuneModel(args.wpath)
    train(args, model)